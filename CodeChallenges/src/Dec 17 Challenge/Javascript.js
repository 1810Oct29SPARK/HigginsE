...
window.onload = function () {
    document.getElementById('currentRates').addEventListener("click", currentAPI);
    var title = document.createElement('p');
    var titleContent = document.createTextNode("Currency Exchange Rates");
